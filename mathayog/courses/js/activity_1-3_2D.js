...
const feedbackArr = [
        "Correct! Since we illustrate ones using single blocks,4 ones are illustrated as 4 single blocks. ",
        "Check the figures. Which contains the correct number of blocks to represent 4 ones?"
    ];
...
continueButton.addEventListener('click', function () {
    ...
    //redirect page
    if (correct == true){
        window.location.href = '../views/activity_1-3_2E.html';
    }
});
