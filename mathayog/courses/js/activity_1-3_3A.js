...
const feedbackArr = [
        "Correct! Since the TENS digit of 71 is 7, we have 7 tens. We can also break down 71 into 70 + 1, which shows that 71 consists of 7 tens and 1 ones. ",
...
continueButton.addEventListener('click', function () {
    ...
    //redirect page
    if (correct == true){
        window.location.href = '../views/activity_1-3_3B.html';
    }
});
