...
const feedbackArr = [
        "Correct! Since we illustrate ones using single blocks, 8 ones are illustrated as  single blocks.",
        "Check the figures. Which contains the correct blocks to represent 8 ones?"
    ];
...
continueButton.addEventListener('click', function () {
    ...
    //redirect page
    if (correct == true){
        window.location.href = '../views/activity_1-3_4E.html';
    }
});
