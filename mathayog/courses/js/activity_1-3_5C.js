...
const feedbackArr = [
        "Correct! Since the ONES digit of 93 is 3, we have 3 ones. We can also break down 93 into 90 + 3, which shows that 93 consists of 9 tens and 3 ones. ",
...
continueButton.addEventListener('click', function () {
    ...
    //redirect page
    if (correct == true){
        window.location.href = '../views/activity_1-3_5D.html';
    }
});
