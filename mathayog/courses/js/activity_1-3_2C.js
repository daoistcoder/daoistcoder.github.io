...
const feedbackArr = [
        "Correct! Since the ONES digit of 54 is 4, we have 4 ones. We can also break down 54 into 50 + 4, which shows that 54 consists of 5 tens and 4 ones. ",
...
continueButton.addEventListener('click', function () {
    ...
    //redirect page
    if (correct == true){
        window.location.href = '../views/activity_1-3_2D.html';
    }
});
