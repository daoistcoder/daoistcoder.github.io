...
const feedbackArr = [
        "Correct! Since we illustrate tens using base-10 blocks, 7 tens are illustrated as 7 base-10 blocks. ",
        "Check the figures. Which contains the correct type of block that represents 7 tens?"
    ];
...
continueButton.addEventListener('click', function () {
    ...
    //redirect page
    if (correct == true){
        window.location.href = '../views/activity_1-3_3C.html';
    }
});
