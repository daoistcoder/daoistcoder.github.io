...
const feedbackArr = [
        "Correct! Since we illustrate tens using base-10 blocks, 9 tens are illustrated as 9 base-10 blocks.",
        "Check the figures. Which contains the correct number of blocks that represent 9 tens?"
    ];
...
continueButton.addEventListener('click', function () {
    ...
    //redirect page
    if (correct == true){
        window.location.href = '../views/activity_1-3_5C.html';
    }
});
