...
const feedbackArr = [
        "Correct! Since we illustrate tens using base-10 blocks, 2 tens are illustrated as 2 base-10 blocks.",
        "Check the figures. Which contains the correct type of blocks that represent 2 tens? "
    ];
...
continueButton.addEventListener('click', function () {
    ...
    //redirect page
    if (correct == true){
        window.location.href = '../views/activity_1-3_4C.html';
    }
});
