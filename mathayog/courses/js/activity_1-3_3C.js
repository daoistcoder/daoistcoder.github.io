...
const feedbackArr = [
        "Correct! Since the ONES digit of 71  is 1, we have 1 ones. We can also break down 71 into 70 + 1, which shows that 71 consists of 7 tens and 1 ones. ",
...
continueButton.addEventListener('click', function () {
    ...
    //redirect page
    if (correct == true){
        window.location.href = '../views/activity_1-3_3D.html';
    }
});
