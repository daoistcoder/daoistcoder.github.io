...
const feedbackArr = [
        "Correct! Since we illustrate ones using single blocks, 1 ones is illustrated as 1 single block. ",
        "Check the figures. Which contains the correct block to represent 1 ones?"
    ];
...
continueButton.addEventListener('click', function () {
    ...
    //redirect page
    if (correct == true){
        window.location.href = '../views/activity_1-3_3E.html';
    }
});
