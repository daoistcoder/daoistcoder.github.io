...
const feedbackArr = [
        "Correct! Since the ONES digit of 28 is 8, we have 8 ones. We can also break down 28 into 20 + 8, which shows that 28 consists of 2 tens and 8 ones.",
...
continueButton.addEventListener('click', function () {
    ...
    //redirect page
    if (correct == true){
        window.location.href = '../views/activity_1-3_4D.html';
    }
});
